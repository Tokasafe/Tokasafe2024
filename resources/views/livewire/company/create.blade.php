<div>
    ...
    <label for="uploadCompany" class="btn btn-sm btn-square btn-warning tooltip-warning tooltip-top tooltip"
        data-tip="Import">
        ...
        <div class="modal-box">
            ...
            <form wire:submit.prevent='storeCompany'>
                ...
                <div class="w-full max-w-xs form-control">
                    <x-input-label-req :value="__('Company Category')" />
                    ...
                    <x-input-error :messages="$errors->get('company_category_id')" class="mt-0" />
                </div>
                <div class="w-full max-w-xs form-control">
