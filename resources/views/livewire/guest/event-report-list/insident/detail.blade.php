<div>
    ...
    @endpush
    @section('bradcrumbs')
        {{ Breadcrumbs::render('incidentDetailsGuest', $data_id) }}
    @endsection
                        ...
                        <div class="w-full max-w-xl form-control">
                            ...
                            <label class="join " wire:click='openWokrgroup'>
                                <input type="text" placeholder="Type here" wire:model='workgroup' readonly
                                    ...
                                    @if ($IncidentClose) disabled @endif />
                                <label for=""
                                    class="border btn btn-xs btn-square join-item @error('workgroup') btn-error @enderror"
                                    btn-info {{ $IncidentClose ? 'btn-disabled' : '' }}">
                       ...
                       <div class="w-full max-w-xl form-control">
                            ...
                            <label class="join" wire:click='openReportBy'>
                                <input type="text" placeholder="Type here" wire:model='reporter_name' readonly
                                    ...
                                    @if ($IncidentClose) disabled @endif />
                                <label for=""
                                    class="border btn btn-xs btn-square join-item @error('reporter_name') btn-error @enderror"
                                    btn-info {{ $IncidentClose ? 'btn-disabled' : '' }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="w-full max-w-xl form-control">
                            ...
                            <label wire:click='openReportTo' class="join">
                                <input type="text" placeholder="Type here" wire:model='report_to'
                                    ...
                                    @if ($IncidentClose) disabled @endif />
                                <label for=""
                                    class="border btn btn-xs btn-square join-item @error('report_to') btn-error @enderror"
                                    btn-info {{ $IncidentClose ? 'btn-disabled' : '' }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                        <path stroke-linecap="round" stroke-linejoin="round"
