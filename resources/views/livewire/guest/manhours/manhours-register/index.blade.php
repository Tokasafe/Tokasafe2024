<div class="mt-8">
    ...
    @include('toast.toast')
    @section('bradcrumbs')
    {{ Breadcrumbs::render('ManhoursGuest') }}
@endsection
        ...
        <div class="w-auto md:join">
            <div class="relative join-item ">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"class="w-4 h-4 absolute left-0 my-1.5 ml-2 font-bold">
                  ...
                  autocomplete="off"
                  class="w-48 pl-6 input input-bordered placeholder:italic placeholder:text-slate-400 input-success input-xs focus:outline-none rounden-sm focus:ring-success focus:ring-1" />
            ...
            {{-- <div class="relative join-item ">
                ...
                <select wire:model='searchCompanyCategory' class="w-full max-w-xs pl-6 select select-bordered placeholder:italic placeholder:text-slate-400 select-success select-xs focus:outline-none rounden-sm focus:ring-success focus:ring-1">
             ...
             <div class="relative join-item ">
                ...
                <select wire:model='searchCompany' class="w-full max-w-xs pl-6 select select-bordered placeholder:italic placeholder:text-slate-400 select-success select-xs focus:outline-none rounden-sm focus:ring-success focus:ring-1">
