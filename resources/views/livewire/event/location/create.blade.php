<div>
    ...
    <div class="modal ">
        <div class="modal-box">
            <h3 class="text-lg font-bold text-center">Add Event Location</h3>
            <form wire:submit.prevent='store'>
                ...
                <div class="w-full max-w-xs form-control">
                    ...
                    <input type="text" placeholder="Type here" wire:model='name'
                        class=" @error('name') border-rose-500 border-2 @enderror capitalize w-full max-w-xs input input-bordered input-success input-sm focus:outline-none focus:border-success focus:ring-success focus:ring-1" />
    ...
    <div class="modal">
        <div class="modal-box">
            <div class="divider divider-primary">Import Event Location</div>
            <form wire:submit.prevent='uploadLocation'>
                @csrf
                ...
                <div class="modal-action">
                    <button type="submit" class="text-white btn btn-success btn-xs">Save
                        ...
                        <svg wire:loading wire:target="uploadLocation"
                            wire:loading.class="loading loading-spinner loading-xs." viewBox="0 0 24 24">
                            <!-- ... -->
                        </svg>
                    </button>
