<div>
    ...
    <!-- The button to open modal -->
    <div class="flex">
        <label for="addPC" class="btn btn-sm btn-square btn-info "><svg xmlns="http://www.w3.org/2000/svg"
        ...
        <label for="uploadEventCategory" class="btn btn-sm btn-square btn-warning tooltip-warning tooltip-top tooltip"
            data-tip="Import">
    ...
    <div class="modal ">
        <div class="modal-box">
            <h3 class="text-lg font-bold text-center">Add Event Category</h3>
    ...
    <input type="checkbox" id="uploadEventCategory" class="modal-toggle" />
    <div class="modal">
      <div class="modal-box">
        <div class="divider divider-primary">Import Event Category</div>
        <form wire:submit.prevent='uploadEventCategories'  wire:target="uploadEventCategories" wire:loading.class="skeleton ">
            @csrf 
                <div class="w-full max-w-xs form-control">
            ...
            <div class="modal-action">
                <button type="submit" class="text-white btn btn-success btn-xs">Save
                    ...
                    <svg wire:loading wire:target="fileImport" wire:loading.class="loading loading-spinner loading-xs.">
                        <!-- ... -->
                      </svg>
                </button>
                <label for="uploadEventCategory" class="btn btn-xs btn-error">Close!</label>
            </div>
        </form>
