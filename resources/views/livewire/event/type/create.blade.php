<div>
    ...
    <div class="flex">
        ...
        <label for="uploadEventType" class="btn btn-sm btn-square btn-warning tooltip-warning tooltip-right tooltip "
            data-tip="Import">
    ...
    <input type="checkbox" id="uploadEventType" class="modal-toggle" />
    <div class="modal">
        <div class="modal-box">
            <div class="divider divider-primary">Import Event Type</div>
            <form wire:submit.prevent='uploadEventTypes'>
                @csrf
                ...
                <div class="modal-action">
                    <button type="submit" class="text-white btn btn-success btn-xs">Save
                        ...
                        <svg wire:loading wire:target="uploadEventTypes"
                            wire:loading.class="loading loading-spinner loading-xs">
                            <!-- ... -->
                        </svg>
                    </button>
                    <label for="uploadEventType" class="btn btn-xs btn-error">Close!</label>
                </div>
            </form>
