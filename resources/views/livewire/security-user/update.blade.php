<div>
    ...
    <div class="modal @if (!empty($openModal)) modal-open @endif">
        <div class="modal-box w-auto">
            <div class="divider divider-accent m-0">Update User Security!</div>
                ...
                <div class="px-4 m-2 overflow-y-auto border w-80 border-stone-400 h-52">
                    <div class="flex gap-2 py-1">
                        ...
                        <label wire:click='clearSelect' for=""
                            class=" btn btn-info btn-square btn-sm tooltip btn-outline tooltip-info tooltip-bottom"
                            data-tip='clear filter'>
                            <svg class="pb-3 pr-2" width="40px" height="40px" viewBox="0 0 512 512" version="1.1"
                            ...
                            <tr class="gap-2">
                                <label>
                                    <li class="flex m-2 text-xs hover:bg-cyan-200">
                                        <input wire:model="selectedUser" value="{{ $person->id }}" type="radio"
                                            class="mr-2 radio radio-sm checkbox-success @error('selectedUser') border border-rose-500 @enderror" />
