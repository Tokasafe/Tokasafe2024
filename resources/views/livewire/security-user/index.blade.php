<div class="mt-6">
    ...
    <div class="mx-4 my-4 overflow-x-auto rounded-md shadow-md">
        <table class="table table-xs">
            ...
            <tbody>
                @forelse ($UserSecurity as $index => $item)
                    <tr class="text-center">
                        ...
                        <td>
                            <div class="flex flex-row justify-center gap-1">
                                ...
                                <label wire:click="update_UserSecurity({{ $item->id }})"
                                    class="btn btn-xs btn-warning ">Edit</label>
                                <label for="delete_data" wire:click="deleteUserSecurity({{ $item->id }})"
