...
<div class="p-2">
                    ...
                    <table class="table table-xs ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border border-gray-300"><label {{ $hazardClose ? 'disabled' : '' }}
                                        wire:click='btn_a1'
    ...
    <div class="flex flex-col items-center border-b sm:flex-row">
        <div class="text-[9px] font-semibold basis-1/4 ">{{ __('risk_rank') }}</div>
        <div class="text-[9px] basis-3/4">: {{ $name_assessment }}</div>
    </div>
    <div class="flex flex-col items-center border-b sm:flex-row">
        <div class="text-[9px] font-semibold basis-1/4 ">{{ __('notify') }}</div>
        <div class="text-[9px] basis-3/4">: {{ $notes_assessment }}</div>
    </div>
    <div class="flex flex-col items-center border-b sm:flex-row">
        <div class="text-[9px] font-semibold basis-1/4 ">{{ __('deadline') }}</div>
        <div class="text-[9px] basis-3/4">: {{ $reporting_obligation_assessment }}</div>
    </div>
    <div class="flex flex-col items-center border-b sm:flex-row">
        <div class="text-[9px] font-semibold basis-1/4 ">{{ __('Coordinator') }}</div>
        <div class="text-[9px] basis-3/4">: {{ $investigation_req_assessment }}</div>
    </div>
</div>
