<div>
    ...
    <div class="m-1  p-2 rounded-md sm:w-full ">
        ...
        <div class="flex flex-row pl-2 sm:pl-0">
            ...
            <div class="w-40 text-xs text-gray-500 font-semibold">: {{ date('d-M-Y', strtotime($date_event)) }}
            </div>
        </div>
        <div class="flex flex-row pl-2 sm:pl-0">
    ...
    <div class="shadow-md ">
        <form wire:submit.prevent='updateStore' wire:loading.class="skeleton" wire:target="updateStore">
            @csrf
            @method('PATCH')
            <div class="top-0 z-10 p-2 bg-white shadow-md sm:sticky">
                ...
                <label for="my_modal_3" class="btn btn-xs btn-error text-white">{{ __('Delete') }}!</label>
            </div>
            <div class=" {{ $IncidentClose ? 'stack' : '' }}">
                <div
                    class=" {{ $IncidentClose ? 'overflow-y-auto sm:h-[18rem] xxl:h-[22rem] 2xl:h-[40rem] p-2' : 'overflow-y-auto sm:h-[18rem] xl:h-[22rem] 2xl:h-[40rem] p-2 ' }}">
                    <div class="flex flex-wrap gap-1 sm:grid  sm:grid-cols-4">
                        ...
                        <div class="w-full max-w-xl form-control ">
                            ...
                            <fieldset class="border px-1 py-0">
                        ...
                        <div class="w-full max-w-xl form-control flex flex-row">
                            ...
                            @if ($documentation)
                                <div wire:click='download' class="flex-none w-10 cursor-pointer ">
                                    <div class="p-2 mt-3">
                                        <i
                                            class="{{ pathinfo(public_path($documentation))['extension'] === 'jpg' ? 'fa-sharp fa-regular fa-file-image fa-2xl' : '' }}
                                {{ pathinfo(public_path($documentation))['extension'] === 'JPG' ? 'fa-sharp fa-regular fa-file-image fa-2xl' : '' }}
                                {{ pathinfo(public_path($documentation))['extension'] === 'jpeg' ? 'fa-sharp fa-regular fa-file-image fa-2xl' : '' }}
                                {{ pathinfo(public_path($documentation))['extension'] === 'png' ? 'fa-sharp fa-regular fa-file-image fa-2xl' : '' }}
                                {{ pathinfo(public_path($documentation))['extension'] === 'xlsx' ? 'fa-sharp fa-regular fa-file-excel fa-2xl' : '' }}
                                {{ pathinfo(public_path($documentation))['extension'] === 'pdf' ? 'fa-sharp fa-regular fa-file-pdf fa-2xl' : '' }}
                                {{ pathinfo(public_path($documentation))['extension'] === 'docx' ? 'fa-sharp fa-regular fa-file-word fa-2xl' : '' }}">
                                        </i>
                                    </div>
                                </div>
                            @endif
                ...
                <div
                    ...
                    <p
                        class=" {{ $IncidentClose ? 'self-center text-6xl sm:text-9xl font-black font-mono text-gray-300 italic z-20' : 'hidden' }}">
                        CLOSED</p>
                </div>
            </div>
        </form>
