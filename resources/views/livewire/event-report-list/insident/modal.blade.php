        ...
        <div class="flex flex-col justify-end gap-1 -mt-3 join sm:flex-row sm:gap-0">
            ...
            <div class="relative flex items-center max-w-xs shadow-sm join-item ">
                ...
                <fieldset class="flex items-start p-[3px] border  gap-0.5">
                    <input wire:model.live="radio_select" id="cl"
                        class="radio-xs peer/cl checked:bg-rose-500 radio" type="radio" value="companyLevel" />
                    <label for="cl"
                        class="text-xs font-semibold peer-checked/cl:text-rose-500">{{ __('Company Level') }}</label>

                    <input wire:model.live="radio_select" id="wg"
                        class="radio-xs peer/wg checked:bg-sky-500 radio" type="radio" value="workgroup" />
                    <label for="wg"
                        class="text-xs font-semibold peer-checked/wg:text-sky-500">{{ __('Workgroup') }}</label>
