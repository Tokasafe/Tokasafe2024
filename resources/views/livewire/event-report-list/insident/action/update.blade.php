<div>
    ...
    <div class="{{$openModalUpdate}}" role="dialog">
        <div class="w-11/12 max-w-4xl modal-box">
            ...
            <form >
                ...
                <div class="modal-action">
                    <label wire:click='updateStore' class="btn btn-success btn-xs">{{ __('Save') }}</label>
                    <label  wire:click='closeModalUpdate' class="btn btn-error btn-xs">Close!</label>
                </div>
            </form>
        </div>
    </div>
