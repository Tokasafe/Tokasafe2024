        ...
        <div class="divide-y divide-secondary basis-full divide-solid">
            <div class="flex flex-col items-center gap-4 m-2 sm:flex-row">
                <div class="w-full max-w-xs basis-1/2 form-control">
                    ...
                    <x-select-edit wire:model='actual_outcome' :closed="$IncidentClose" :error="$errors->get('actual_outcome')">
            ...
            <div class="flex flex-col items-center gap-4 m-2 sm:flex-row">
                <div class="w-full max-w-xs basis-1/2 form-control">
                    ...
                    <x-select-edit wire:model='potential_consequence' :closed="$IncidentClose" :error="$errors->get('potential_consequence')">
                        <option value="" selected>select an item</option>
                        @foreach ($Consequence as $item)
                            <option value="{{ $item->id }}">{{ $item->name }}</option>
                        @endforeach
            ...
            <div class="flex flex-col items-center gap-4 m-2 sm:flex-row">
                <div class="w-full max-w-xs basis-1/2 form-control">
                    ...
                    <x-select-edit wire:model='potential_likelihood' :closed="$IncidentClose" :error="$errors->get('potential_likelihood')">
                        <option value="" selected>select an item</option>
