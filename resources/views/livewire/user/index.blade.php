        ...
        <div>
            <div class="relative ">
                ...
                <input wire:model='search'
                    class="block w-full py-2 pr-3 bg-white border-2 rounded-md shadow-sm input-sm placeholder:italic placeholder:text-slate-400 border-emerald-300 pl-11 focus:outline-none focus:border-emerald-500 focus:ring-emerald-500 focus:ring-1 sm:text-sm"
    ...
    <div class="mx-4 mt-4 overflow-x-auto rounded-md shadow-md">
        <table class="table table-xs">
            ...
            <tbody>
                ...
                @empty
                    <tr class="text-center">
                        <td colspan="4" class="font-semibold text-rose-500">data not found!!</td>
                    </tr>
                @endforelse
            </tbody>
